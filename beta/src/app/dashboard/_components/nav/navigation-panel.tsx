...
<aside {...(id ? { id } : {})} className={`${mobile ? "fixed md:hidden" : ""} ${mobile ? "inset-y-0 left-0 z-50 transition-all duration-200" : ""} ${mobile ? (open ? "translate-x-0" : "-translate-x-full") : ""} ${sidebarClasses} flex-col border-r border-border bg-white overflow-y-auto scroll-hide flex-shrink-0 lg:pb-0 pb-[80px]`}
