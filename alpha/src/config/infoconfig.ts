  ...
  sections: [
    {
      title: 'Overview',
      description:
        'The Workspaces page allows you to manage your workspaces and switch between them. This feature is powered by Better Auth organization management, which enables multi-tenant workspace management. You can view all available workspaces, create new ones, and switch your active workspace.',
      links: [
        {
    ...
    },
    {
      ...
      description:
        "This application follows Better Auth recommended patterns for multi-tenant authentication. Server-side permission checks ensure that users can only access resources for their active organization.",
      links: [
        {
          title: 'Better Auth Documentation',
          url: 'https://www.better-auth.com/docs'
  ...
  sections: [
    {
      title: 'Overview',
      description:
        "The Team Management page allows you to manage your workspace team, including members, roles, security settings, and more. This page provides comprehensive organization management through the organization management interface.",
      links: [
        {
          title: 'Better Auth Documentation',
          url: 'https://www.better-auth.com/docs'
    ...
    },
    {
      ...
      description:
        'Configure default roles and permissions in the admin dashboard. Roles define what actions team members can perform within the workspace. Common roles include admin, member, and custom roles you define.',
      links: [
        {
          title: 'Better Auth Documentation',
          url: 'https://www.better-auth.com/docs'
  ...
  sections: [
    {
      title: 'Overview',
      description:
        "The Billing page allows you to manage your organization's subscription and usage limits. Plans and subscriptions are managed through subscription billing via Stripe integration, which provides organization-level subscription management with integrated Stripe payment processing.",
      links: [
        {
          title: 'Better Auth Documentation',
          url: 'https://www.better-auth.com/docs'
    ...
    },
    {
      ...
      description:
        'View and subscribe to available plans through the pricing table. Plans are created and managed in the admin dashboard. Toggle "Publicly available" on plans to show them in the pricing table. Common plans include free, pro, and team tiers.',
      links: [
        {
          title: 'Admin Dashboard - Plans',
          url: '#'
        }
      ]
    },
    {
      title: 'Plan Features',
      description:
        'Each plan can include specific features that unlock functionality in the application. Features are added to plans in the admin dashboard and can be checked in code using the `has()` function with `feature` checks.',
      links: []
    },
    {
    ...
    },
    {
      ...
      description:
        "Billing infrastructure costs vary depending on your provider. Plans and pricing are managed through the admin dashboard. Stripe is used for payment processing.",
      links: []
    },
    {
      title: 'Setup Requirements',
      description:
        "To enable billing, configure your Stripe integration in the admin dashboard. Choose between a test gateway (for testing) or your own Stripe account (for production). Note: A Stripe account created for development cannot be used for production.",
      links: []
    },
    {
      title: 'Beta Status',
      description:
        'Billing is currently in Beta and its APIs are experimental and may undergo breaking changes. To mitigate potential disruptions, we recommend pinning your SDK and `better-auth` package versions.',
      links: []
    }
  ]
};
